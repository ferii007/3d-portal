...
const FloatingRocks = () => {
    ...
    return(
        <>
            <Float speed={0.5} rotationIntensity={1.6} floatIntensity={0} position={[ -5, 10, -33 ]}>
                <primitive object={rock1.scene} />
            </Float>

            <Float speed={0.5} rotationIntensity={1.6} floatIntensity={0} position={[ -20.5, -7, -19 ]}>
                <primitive object={rock2.scene} />
            </Float>

            <Float speed={0.5} rotationIntensity={1.6} floatIntensity={0} position={[ 20, 3.5, -9 ]}>
